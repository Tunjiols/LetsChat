...
/**
 * Created by adetunji on 14/01/2018.
 */

public class NetworkConnectionUtil {

    public static final String ERR_DIALOG_TITLE = "No internet connection detected !";
    private static final String ERR_DIALOG_MSG = "Looks like the application is unable to detect an active internet connection, " +
    ...
    public static void showNoInternetAvailableErrorDialog(final Context context) {
        new AlertDialog.Builder(context)
                ...
                .setIcon(R.drawable.warning_red_icon)
