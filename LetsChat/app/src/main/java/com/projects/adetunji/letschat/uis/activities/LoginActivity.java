...
import com.projects.adetunji.letschat.uis.fragments.LoginFragment;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        fragmentTransaction.replace(R.id.frame_layout_content_login, LoginFragment.newInstance(),
