...
import com.projects.adetunji.letschat.fcm.FcmNotificationBuilder;
...
public class ChatInteractor implements ChatContract.Interactor{
    ...
    public void getMessageFromFirebaseUser(String senderUid, String receiverUid) {
        ...
        databaseReference.child(Constants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(
                ...
                if (dataSnapshot.hasChild(room_type_1)) {
                    ...
                    FirebaseDatabase.getInstance()
                        ...
                        public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                            ...
                            Log.e(TAG, "getMessageFromFirebaseUser: " + room_type_1 + " get values successful");
                        }
