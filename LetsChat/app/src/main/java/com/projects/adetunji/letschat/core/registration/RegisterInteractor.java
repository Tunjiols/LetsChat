...
public class RegisterInteractor implements RegisterContract.Interactor {
    ...
    private RegisterContract.OnRegistrationListener mpOnRegistrationListener;

    public RegisterInteractor(RegisterContract.OnRegistrationListener onRegistrationListener) {
        this.mpOnRegistrationListener = onRegistrationListener;
    }
                ...
                .addOnCompleteListener(activity, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            mpOnRegistrationListener.onFailure(task.getException().getMessage());
                        } else {
                            ...
                            mpOnRegistrationListener.onSuccess(task.getResult().getUser());
                        }
                    }
                });
    }
