...
public class LoginInteractor implements LoginContract.Interactor {
    private LoginContract.OnLoginListener appOnLoginListener;

    public LoginInteractor(LoginContract.OnLoginListener onLoginListener) {
        this.appOnLoginListener = onLoginListener;
    }
                ...
                .addOnCompleteListener(activity, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            appOnLoginListener.onSuccess(task.getResult().toString());
                            ...
                            appOnLoginListener.onFailure(task.getException().getMessage());
                        }
                    }
                });
    }
